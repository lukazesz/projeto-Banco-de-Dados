...
<head>
    ...
    <title>Buscar Jogos por Usuário</title>
            ...
            <div class="col-md-6 col-lg-5">
                ...
                <div class="card bg-dark text-light shadow-lg p-4">
                    ...
                    <h2 class="text-center mb-4">
                        <i class="bi bi-person-search"></i> Buscar Jogos por Usuário
                    </h2>

                    <form action="listarJogosPorUsuario" method="get">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/app-web" class="btn btn-outline-light">
